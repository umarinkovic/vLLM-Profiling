...
def main():
    ...
    prompts = prepare_prompts(load_prompts(Path("/workspace/yaml/prompts/multimodal.yaml")), load_images(Path("/workspace/images/multimodal"))) 
    processor = AutoProcessor.from_pretrained("Qwen/Qwen3-VL-4B-Instruct")
    parsed_prompts = [prepare_inputs_for_vllm(prompt, processor) for prompt in [prompts]]
